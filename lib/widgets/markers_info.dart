...
class ShowMarkerInfo extends StatefulWidget {
  ...
  @override
  State<ShowMarkerInfo> createState() => _ShowMarkerInfoState();
}

class _ShowMarkerInfoState extends State<ShowMarkerInfo> {
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: const [
                  BoxShadow(
                    color: Color.fromARGB(255, 231, 251, 239),
                    blurRadius: 4,
                    spreadRadius: 1,
                  ),
                ],
            ...
            Container(
              ...
              child: Wrap(
                children: [
                  Text(widget.about, style: TextStyle(color: mainColor))
                ],
              ),
            ),
            Container(
