...
class NotificationsService {
  static const key =
      "AAAAlPA54W8:APA91bGh1fubC6uuQICCBqTdV0oWF5jKsDN8av7rwR0_6Plbg2ppSX0EaO2jhfPEXofgZyrss0vPmfNKx66TZhFpoEOzlL3FvtzIKG2De4C965OF-SadpENbjNhIbnD4sFx_aDqvIia0";
  ...
  void _initLocalNotification() {
    const androidSettings =
        AndroidInitializationSettings('@drawable/logowhite');
  ...
  Future<void> _showLocalNotification(RemoteMessage message) async {
    ...
    final androidDetails = AndroidNotificationDetails(
      'com.example.street_wyze.urgent',
      'mychannelid',
    ...
    FirebaseMessaging.onMessageOpenedApp.listen(
      (RemoteMessage message) async {
        await Navigator.of(context).push(
          MaterialPageRoute(
            builder: (_) => UserFeedback(receiverId: message.data['senderId']),
          ),
        );
      },
    );
